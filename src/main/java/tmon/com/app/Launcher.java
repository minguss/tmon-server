...
import tmon.com.app.db.base.RedisPool;

public class Launcher {
	
	//change this value for as number^^;
	final private int asNo = 0;

	//port = 8080 + asNo!
	final private int port = 8080 + asNo;
	...
	public static void main(String[] args) {
		//notice usage
		if (args.length < 1) {
			System.out.println("java -jar tmon-server-1.0.0-fat.jar ID");
